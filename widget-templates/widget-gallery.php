...
?>
	...
	?>
		<div class="maranatha-gallery-widget-link">
			<a href="<?php echo esc_url( get_permalink( $instance['post_id'] ) ); ?>" title="<?php echo esc_attr( get_the_title( $instance['post_id'] ) ); ?>" class="maranatha-button">
				<span class="<?php maranatha_icon_class( 'gallery' ); ?> maranatha-button-icon"></span>
				<?php _ex( 'View Gallery', 'gallery widget', 'maranatha' ); ?>
			</a>
		</div>
	<?php endif; ?>
...
?>
	...
	<div>
		<?php _ex( 'There are no images to show.', 'gallery widget', 'maranatha' ); ?>
	</div>

...
$cat_args = apply_filters( 'maranatha_widget_categories_args', $cat_args );

// Show as dropdown
if ( ! empty( $instance['show_dropdown'] ) ) {

	// Add category arguments to base array
	$cat_args['show_option_none'] = _x( 'Select One', 'categories widget', 'maranatha' );
	$cat_args['id'] = 'maranatha-dropdown-taxonomy_id-' . rand( 10000, 99999 );
	$cat_args['name'] = $cat_args['id'];
	$cat_args['class'] = 'maranatha-dropdown-taxonomy-redirect';

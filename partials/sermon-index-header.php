 ...
 * Sermon Index Header
 *
 * Buttons for switching between semron indexes, if available (Topics, Series, Books, etc.)
 */
...
$archives_meta = array(
	...
	'months' => array(
		...
		'icon'			=> 'sermon-date',
		'name'			=> _x( 'Dates', 'sermon archives', 'maranatha' ), // override
	),
);
...
<div id="maranatha-sermon-index-header">
	...
	<ul class="maranatha-circle-buttons-list">
		...
		foreach ( $buttons as $button ) :
			...
			?><li>
				<a href="<?php echo esc_url( $button['url'] ); ?>"<?php if ( $button['selected'] ) : ?> class="maranatha-circle-button-selected"<?php endif; ?>>
					<span class="<?php maranatha_icon_class( $button['icon'] ); ?>"></span>
